  ...
  $('#author-filter').on('change', function() {
    if ($(this).val()) {
      ...
      */
      $('article').hide();
      $('article').val();
      $('article[data-attribute="' + $(this).val() +'"]').attr('option', sourceData).fadeIn(800);
...
articleView.handleCategoryFilter = function() {
  $('#category-filter').on('change', function() {
    if ($(this).val()) {
      ...
      $('category').hide();
      $('category').val();
      $('article[data-category="' + $(this).val() +'"]').attr('option', sourceData).fadeIn(800);
...
articleView.setTeasers = function() {
  ...
  /* TODONE: Add a delegated event handler to reveal the remaining paragraphs.
